...
@section('content')
    @include("admin.layout.breadcrumb", ['links' => [
        ...
        ['url' => route("admin.users.create"), 'name' => __("words.create-user"), 'is_active' => true],
    ]])
        ...
        <div class="row">
            <div class="col-12 card-light p-3">
                <form method="POST" action="{{ route("admin.users.store") }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('user_role') is-invalid @enderror"
                            ...
                            @foreach($roles as $role)
                                <option {{ old('user_role') == $role['key'] ? "selected" : "" }}
                    ...
                    <div class="mb-3">
                        <button class="btn btn-primary">{{ __("words.create-user") }}</button>
                    </div>
                </form>
            </div>
        </div>
